...
public class WinnowerUpsertGraphTests : TestBase
{
    [Fact]
    public void UpsertGraph_NewParentNewChildren_AllInserted()
    {
    ...
    [Fact]
    public void UpsertGraph_ExistingParentNewChildren_Mixed()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_NewParentExistingChildren_Mixed()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<CustomerOrder, int>(context);
        var result = saver.UpsertGraph([newOrder]);
    ...
    [Fact]
    public void UpsertGraph_ExistingParentExistingChildren_AllUpdated()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_MixedAtAllLevels()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 2, itemsPerOrder: 2);
        ...
        var saver = new Winnower<CustomerOrder, int>(context);
        var result = saver.UpsertGraph(existingOrders.Append(newOrder));
    ...
    [Fact]
    public void UpsertGraph_ThreeLevel_Works()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_OrphanThrow_ThrowsOnRemoval()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_OrphanDelete_DeletesOrphans()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 2, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpsertGraph_OrphanDetach_DetachesOrphans()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 2, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpsertGraph_GraphHierarchy_Populated()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_TraversalInfo_Accurate()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_WithReferences_Works()
    {
        using var context = CreateContext();
        ...
        var result = saver.Upsert([product]);
    ...
    [Fact]
    public void UpsertGraph_ChildFailure_FailsGraph()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_SkipNavigation_NewStudentWithNewCourses_JoinRecordsCreated()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_SkipNavigation_NewStudentWithExistingCourses_JoinRecordsCreated()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_SkipNavigation_MultipleNewStudents_AllJoinRecordsCreated()
    {
        using var context = CreateContext();
        SeedCourses(context, 4);
        ...
        var saver = new Winnower<Student, int>(context);
        var result = saver.UpsertGraph([student1, student2], new UpsertGraphOptions
        {
            IncludeManyToMany = true
        });
    ...
    [Fact]
    public void UpsertGraph_SkipNavigation_MixedNewAndExistingStudents_BothWork()
    {
        using var context = CreateContext();
        SeedCourses(context, 4);
        ...
        var saver = new Winnower<Student, int>(context);
        var result = saver.UpsertGraph([loadedExisting, newStudent], new UpsertGraphOptions
        {
            IncludeManyToMany = true
        });
    ...
    [Fact]
    public void UpsertGraph_ExplicitJoin_NewStudentWithEnrollments_Works()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<Student, int>(context);
        var result = saver.UpsertGraph([student]);
    ...
    [Fact]
    public void UpsertGraph_ExplicitJoin_ExistingStudentModifyEnrollment_PayloadPreserved()
    {
        using var context = CreateContext();
        SeedCourses(context, 2);
        var courses = context.Courses.ToList();
        ...
        var saver = new Winnower<Student, int>(context);
        var result = saver.UpsertGraph([existingStudent]);
    ...
    [Fact]
    public void UpsertGraph_ExplicitJoin_RemoveEnrollment_WithOrphanDelete()
    {
        using var context = CreateContext();
        SeedCourses(context, 2);
        var courses = context.Courses.ToList();
        ...
        var saver = new Winnower<Student, int>(context);
        var result = saver.UpsertGraph([existingStudent], new UpsertGraphOptions
        {
            OrphanedChildBehavior = OrphanBehavior.Delete
        });
    ...
    [Fact]
    public void UpsertGraph_M2M_TraversalInfo_TracksJoinRecords()
    {
        using var context = CreateContext();
        SeedCourses(context, 3);
        var courses = context.Courses.ToList();
    ...
    [Fact]
    public void UpsertGraph_WithReference_NewOrderNewProduct_BothInserted()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_WithReference_ExistingOrderUpdateItem_Updated()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<CustomerOrder, int>(context);
        var result = saver.UpsertGraph([existingOrder]);
    ...
    [Fact]
    public void UpsertGraph_WithReference_NewOrderExistingProduct_OrderInsertedProductUnchanged()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_MultiLevelReference_CategoryProductOrder_AllUpserted()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_CircularReference_IgnoreMode_Works()
    {
        using var context = CreateContext();
        ...
        var result = saver.UpsertGraph([childCategory], new UpsertGraphOptions
        {
            IncludeReferences = true,
            CircularReferenceHandling = CircularReferenceHandling.Ignore
        });
