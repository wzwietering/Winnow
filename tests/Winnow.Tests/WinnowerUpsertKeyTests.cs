...
public class WinnowerUpsertKeyTests : TestBase
{
    [Fact]
    public void Upsert_IntKey_ZeroIsInsert()
    {
    ...
    [Fact]
    public void Upsert_IntKey_NonZeroIsUpdate()
    {
        using var context = CreateContext();
        SeedData(context, 5);
    ...
    [Fact]
    public void Upsert_LongKey_ZeroIsInsert()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_LongKey_NonZeroIsUpdate()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_GuidKey_EmptyIsInsert()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_GuidKey_NonEmptyIsUpdate()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_StringKey_NullDetectedAsInsert()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_StringKey_EmptyIsInsert()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_StringKey_NonEmptyIsUpdate()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_CompositeKey_AllDefaultsIsInsert()
    {
        using var context = CreateContext();
        ...
        var result = saver.Upsert([orderLine]);
    ...
    [Fact]
    public void Upsert_CompositeKey_AnyNonDefaultIsUpdate()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<OrderLine>(context);
        var result = saver.Upsert([existingLine]);
    ...
    [Fact]
    public void Upsert_CompositeKey_ThreePart_Works()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<InventoryLocation>(context);
        var result = saver.Upsert([existingLocation]);
    ...
    [Fact]
    public void Upsert_AutoDetectApi_Works()
    {
        using var context = CreateContext();
        SeedData(context, 3);
    ...
    [Fact]
    public void Upsert_ExplicitKeyApi_Works()
    {
        using var context = CreateContext();
        SeedData(context, 3);
    ...
    [Fact]
    public void Upsert_MixedKeyValues_CorrectRouting()
    {
        using var context = CreateContext();
        SeedData(context, 5);
