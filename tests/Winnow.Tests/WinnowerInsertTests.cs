...
public class WinnowerInsertTests : TestBase
{
    [Fact]
    public void Insert_SingleEntity_ReturnsGeneratedId()
    {
    ...
    [Fact]
    public void Insert_MultipleEntities_AllInsertedWithIds()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_EmptyCollection_ReturnsEmptyResult()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_ValidationError_TracksFailureWithIndex()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_PartialFailure_CorrectIndicesTracked()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_LargeDataSet_AllSucceed()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_NavigationValidation_ThrowsIfChildrenPopulated()
    {
        using var context = CreateContext();
        ...
        Should.Throw<InvalidOperationException>(() => saver.Insert([order]))
            .Message.ShouldContain("populated navigation properties");
    }

    [Fact]
    public void Insert_NavigationValidation_Disabled_AllowsPopulated()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<CustomerOrder, int>(context);
        var options = new InsertOptions { ValidateNavigationProperties = false };

        var result = saver.Insert([order], options);

        result.SuccessCount.ShouldBe(1);
    }

    [Fact]
    public void Insert_OneByOne_CorrectRoundTrips()
    {
        using var context = CreateContext();
        ...
        var saver = new Winnower<Product, int>(context);
        var result = saver.Insert(products, new InsertOptions { Strategy = BatchStrategy.OneByOne });

        result.DatabaseRoundTrips.ShouldBe(5);
    }

    [Fact]
    public void Insert_DivideAndConquer_EfficientOnSuccess()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_DivideAndConquer_IsolatesFailures()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_CompleteFailure_AllFailed()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Insert_SuccessRate_CalculatedCorrectly()
    {
        using var context = CreateContext();
