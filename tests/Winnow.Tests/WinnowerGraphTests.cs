...
public class WinnowerGraphTests : TestBase
{
    [Fact]
    public void UpdateGraph_ParentAndChildModified_BothUpdated()
    {
    ...
    [Fact]
    public void UpdateGraph_ParentFails_EntireGraphRollsBack()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 5, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_ChildFails_EntireGraphRollsBack()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 5, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_ReturnsGraphHierarchy()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpdateGraph_MultipleGraphs_OneFailsOthersSucceed()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 5, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_ChildOnlyModified_ParentUnchangedChildUpdated()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_EmptyCollection_ReturnsEmptyResult()
    {
        using var context = CreateContext();

        var saver = new Winnower<CustomerOrder, int>(context);
        var result = saver.UpdateGraph([]);
    ...
    [Fact]
    public void UpdateGraph_LargeBatch_CompletesSuccessfully()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpdateGraph_OrphanThrow_ThrowsWhenChildRemoved()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
        ...
        var ex = Should.Throw<InvalidOperationException>(() =>
            saver.UpdateGraph(orders)); // Default is OrphanBehavior.Throw
    ...
    [Fact]
    public void UpdateGraph_OrphanDelete_RemovesChildFromDatabase()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_OrphanDetach_LeavesChildInDatabase()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_OrphanDelete_AllChildrenRemoved()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
    ...
    [Fact]
    public void UpdateGraph_OrphanDelete_MultipleOrphansFromMultipleGraphs()
    {
        using var context = CreateContext();
        SeedCustomerOrders(context, 3, itemsPerOrder: 3);
