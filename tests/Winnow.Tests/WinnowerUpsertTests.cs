...
public class WinnowerUpsertTests : TestBase
{
    [Fact]
    public void Upsert_AllNew_AllInserted()
    {
    ...
    [Fact]
    public void Upsert_AllExisting_AllUpdated()
    {
        using var context = CreateContext();
        SeedData(context, 5);
    ...
    [Fact]
    public void Upsert_Mixed_CorrectlyPartitioned()
    {
        using var context = CreateContext();
        SeedData(context, 3);
    ...
    [Fact]
    public void Upsert_EmptyCollection_ReturnsEmptyResult()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_SingleNew_Inserted()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_SingleExisting_Updated()
    {
        using var context = CreateContext();
        SeedData(context, 1);
    ...
    [Fact]
    public void Upsert_Result_TracksInsertedEntities()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_Result_TracksUpdatedEntities()
    {
        using var context = CreateContext();
        SeedData(context, 3);
    ...
    [Fact]
    public void Upsert_Result_AllUpsertedEntities_InOrder()
    {
        using var context = CreateContext();
        SeedData(context, 2);
    ...
    [Fact]
    public void Upsert_Result_TracksDuration()
    {
        using var context = CreateContext();
        SeedData(context, 5);
    ...
    [Fact]
    public void Upsert_Result_TracksRoundTrips()
    {
        using var context = CreateContext();
        SeedData(context, 5);
    ...
    [Fact]
    public void Upsert_PartialFailure_TracksCorrectly()
    {
        using var context = CreateContext();
        SeedData(context, 3);
