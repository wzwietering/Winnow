...
public class WinnowerUpsertFailureTests : TestBase
{
    [Fact]
    public void Upsert_ValidationError_TrackedAsFailure()
    {
    ...
    [Fact]
    public void Upsert_ConcurrencyConflict_TrackedAsFailure()
    {
        using var context = CreateContext();
        SeedData(context, 1);
    ...
    [Fact]
    public void Upsert_FKViolation_TrackedAsFailure()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_UniqueConstraint_TrackedAsFailure()
    {
        using var context = CreateContext();
        ...
        var result = saver.Upsert([order2]);
    ...
    [Fact]
    public void Upsert_Failure_HasAttemptedOperation()
    {
        using var context = CreateContext();
        SeedData(context, 2);
    ...
    [Fact]
    public void Upsert_InsertFailure_AttemptedOperationIsInsert()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_UpdateFailure_AttemptedOperationIsUpdate()
    {
        using var context = CreateContext();
        SeedData(context, 1);
    ...
    [Fact]
    public void Upsert_Failure_HasEntityIndex()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_Failure_HasEntityId_WhenKnown()
    {
        using var context = CreateContext();
        SeedData(context, 3);
    ...
    [Fact]
    public void Upsert_UpdateNonExistent_Fails()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void Upsert_InsertDuplicate_Fails()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public void UpsertGraph_ChildFailure_FailsEntireGraph()
    {
        using var context = CreateContext();
