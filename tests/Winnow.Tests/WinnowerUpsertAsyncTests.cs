...
public class WinnowerUpsertAsyncTests : TestBase
{
    [Fact]
    public async Task UpsertAsync_Works()
    {
        ...
        var result = await saver.UpsertAsync(existingProducts.Concat(newProducts));
    ...
    [Fact]
    public async Task UpsertAsync_WithOptions_Works()
    {
        using var context = CreateContext();
        SeedData(context, 5);
    ...
    [Fact]
    public async Task UpsertAsync_Cancellation_ReturnsWasCancelled()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public async Task UpsertGraphAsync_Works()
    {
        using var context = CreateContext();
        ...
        var result = await saver.UpsertGraphAsync(orders);
    ...
    [Fact]
    public async Task UpsertGraphAsync_WithOptions_Works()
    {
        using var context = CreateContext();
    ...
    [Fact]
    public async Task UpsertGraphAsync_Cancellation_ReturnsWasCancelled()
    {
        using var context = CreateContext();
        ...
        var result = await saver.UpsertGraphAsync(orders, cts.Token);
